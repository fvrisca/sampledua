          ...
          <div class="card-body">
            <div class="row g-auto">
              ...
              <div class="col px-md-1">
                <input name="ID_CARD" type="text" class="form-control" placeholder="ID Card" maxlength="30" required>
              </div>
              <div class="col-auto">
              <label class="col-form-label">Name :</label>
              </div>
              <div class="col px-md-1">
                <input name="NAME" type="text" class="form-control" placeholder="Name" style="text-transform:uppercase" maxlength="30" required>
              </div>
              <div class="col-auto">
              <label class="col-form-label">Address :</label>
              </div>
              <div class="col px-md-1">
                <input name="ADDRESS" type="text" class="form-control" placeholder="Address" style="text-transform:uppercase" maxlength="50" required>
              </div>
              <div class="col-auto">
                <button type="submit" class="btn btn-primary">Submit</button>
                <a href="<?php echo base_url(). 'Dashboard/scanRFID'?>" class="btn btn-info" role="button" aria-pressed="true"> &nbsp; Scan &nbsp;</a>
              </div>
            </div>
          </div>
          </form>
