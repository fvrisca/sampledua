...
<main class="col-md-10 ms-sm-auto col-lg-12 px-md-4">
      ...
      <div class="col-md-12">
        <div class="card ">
          ...
          <!-- start search    -->
          <form action="<?php echo base_url(). 'Dashboard/updatescanRFID';?>" method="post">
          <div class="card-body">
          <?php
            foreach ($datascanRFID as $dS) {
          ?>
            <div class="row g-auto">
              ...
              <div class="col px-md-1">
                <input value="<?php echo $dS->ID_CARD ?>" name="ID_CARD" type="text" class="form-control" placeholder="ID Card" maxlength="30" readonly required>
              </div>
              <div class="col-auto">
              <label class="col-form-label">Name :</label>
              </div>
              <div class="col px-md-1">
                <input value="DEFAULT" name="NAME" type="text" class="form-control" placeholder="Name" style="text-transform:uppercase" maxlength="30" required>
              </div>
              <div class="col-auto">
              <label class="col-form-label">Address :</label>
              </div>
              <div class="col px-md-1">
                <input value="DEFAULT" name="ADDRESS" type="text" class="form-control" placeholder="Address" style="text-transform:uppercase" maxlength="50" required>
              </div>
              <div class="col-auto">
        ...
        <!-- <form action="<?php echo base_url(). 'Dashboard/index'?>" method="post">
          <div class="card-body">
              <div class="row g-auto">
                  <button type="submit" class="btn btn-info btn-lg btn-block" >Scan</button>
              </div>
          </div>
        </form> -->
